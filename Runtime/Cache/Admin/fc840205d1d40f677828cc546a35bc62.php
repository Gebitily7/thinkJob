...
<body>
    ...
    <tbody>
		<?php if(!empty($_list)): if(is_array($_list)): $i = 0; $__LIST__ = $_list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
			...
			<td><?php if(($vo["status"]) == "1"): if($id != 0): ?><a href="<?php echo U('User/changeStatus?method=forbidUser&id='.$vo['uid']);?>" class="ajax-get">禁用</a><?php endif; ?>
				<?php else: ?>
					<?php if($id == 1): ?><a href="<?php echo U('User/detail?tid=1&id='.$vo['id']);?>">认证</a><?php endif; endif; ?>
					<?php if($id == 2): ?><a href="<?php echo U('User/changeIdentify?method=sanctioned&id='.$vo['id']);?>" class="ajax-get">认证</a>
						<a href="<?php echo U('User/changeIdentify?method=unsanctioned&id='.$vo['id']);?>" class="ajax-get">未通过</a>
						<a href="<?php echo U('User/changeIdentify?method=resanctioned&id='.$vo['id']);?>" class="ajax-get">解除</a><?php endif; ?>
                </td>
                <td>
                	<?php if(($vo["hot"]) == "0"): ?><a href="<?php echo U('User/changeHot?method=ishot&uid='.$vo['id']);?>" class="ajax-get">添加热门</a>
						<?php else: ?>
						<a href="<?php echo U('User/changeHot?method=nohot&uid='.$vo['id']);?>" class="ajax-get">移除热门</a><?php endif; ?>
                </td>
    ...
    //导航高亮
    highlight_subnav('<?php echo U("user/identify/id/$id");?>');
	</script>
