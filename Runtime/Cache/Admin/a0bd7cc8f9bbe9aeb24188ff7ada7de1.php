...
<body>
		...
		<div class="tab-content">
			<form action="<?php echo U();?>" method="post" class="form-horizontal">
				...
				<div id="tab1" class="tab-pane in tab1">
					...
					<div class="form-item">
						<label class="item-label">
							菜单是否显示<span class="check-tips">（前台分类主菜单是否显示）</span>
						</label>
						<div class="controls">
					...
					<div class="form-item">
						<label class="item-label">是否热门<span class="check-tips">（前台热门是否显示）</span>
						</label>
						<div class="controls">
							<label class="inline radio"><input type="radio" name="ishot" value="1" <?php echo $info['ishot'] ? 'checked' : '';?>>是</label>
							<label class="inline radio"><input type="radio" name="ishot" value="0" <?php echo $info['ishot'] ? '' : 'checked';?>>否</label>
						</div>
					</div>
					<div class="form-item">
						<label class="item-label">
	...
	<script type="text/javascript">
		...
		//导航高亮
		highlight_subnav('<?php echo U('Cate/index');?>');
	</script>
