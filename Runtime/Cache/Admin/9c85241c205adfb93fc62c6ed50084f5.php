...
<body>
	...
	<div class="cf">
        ...
        <div class="search-form fr cf">
            <div class="sleft">
                <div class="drop-down">
                    <span id="sch-sort-txt" class="sort-txt" data="<?php echo ($is_hot); ?>"><?php if(get_ishot_title($is_hot) == ''): ?>所有<?php else: echo get_ishot_title($is_hot); endif; ?></span>
                    <i class="arrow arrow-down"></i>
                    <ul id="sub-sch-menu" class="nav-list hidden">
                        <li><a href="javascript:;" value="">所有</a></li>
                        <li><a href="javascript:;" value="1">热门</a></li>
                        <li><a href="javascript:;" value="0">非热门</a></li>
                    </ul>
                </div>
                <input type="text" name="name" class="search-input" value="<?php echo I('name');?>" placeholder="请输入城市名称">
                <a class="sch-btn" href="javascript:;" id="search" url="<?php echo U('district/lists','pid='.I('upid',0),false);?>"><i class="btn-search"></i></a>
            </div>
           <!--  <div class="btn-group-click adv-sch-pannel fl">
                ...
                <div class="dropdown cf">
                    <div class="row">
                        <label>持续时间：</label>
                        <input type="text" id="time-start" name="time-start" class="text input-2x" value="" placeholder="发布时间" /> -
                        <input type="text" id="time-end" name="time-end" class="text input-2x" value="" placeholder="结束时间" />
                    </div>
                    <div class="row">
                        <label>联系人：</label>
                        <input type="text" name="linkman" class="text input-2x" value="" placeholder="联系人姓名">
                    </div>
                </div>
            </div> -->
        </div>
...
$(function(){
	...
	$("#search").click(function(){
        ...
        var is_hot = $("#sch-sort-txt").attr("data");
        var query  = $('.search-form').find('input').serialize();
        query = query.replace(/(&|^)(\w*?\d*?\-*?_*?)*?=?((?=&)|(?=$))/g,'');
        query = query.replace(/^&/g,'');
        if(is_hot != ''){
            query = 'is_hot=' + is_hot + "&" + query;
        }
        if( url.indexOf('?')>0 ){
            url += '&' + query;
        }else{
    ...
    highlight_subnav('<?php echo U('District/lists');?>');
});
