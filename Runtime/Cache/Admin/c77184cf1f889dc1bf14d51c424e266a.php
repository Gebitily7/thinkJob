...
<script>
	...
	<div class="main-title">
		...
		<?php if(isset($zhaopin)): ?>：<a href="<?php echo U('index','cate_id='.$cate_id.'&pid='.$zhaopin['id']);?>"><?php echo ($zhaopin["title"]); ?></a><?php endif; ?>
		<?php else: ?>
		<?php if(empty($position)): ?>全部<?php else: ?><a href="<?php echo U('Zhaopin/index');?>">全部</a><?php endif; ?>
	...
	<div class="cf">
		<div class="fl">
			<div class="btn-group">
				<?php if(($allow) > "0"): ?><button class="btn document_add" <?php if(count($model) == 1): ?>url="<?php echo U('zhaopin/add',array('cate_id'=>$cate_id,'pid'=>I('pid',0),'model_id'=>$model[0],'group_id'=>$group_id));?>"<?php endif; ?>>新 增
		...
		<div class="search-form fr cf">
			<div class="sleft">
				...
				<a class="sch-btn" href="javascript:;" id="search" url="<?php echo U('zhaopin/index','pid='.I('pid',0).'&cate_id='.$cate_id,false);?>"><i class="btn-search"></i></a>
			</div>
