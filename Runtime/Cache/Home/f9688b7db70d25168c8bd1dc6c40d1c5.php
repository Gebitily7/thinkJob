        ...
        <div class="job-detail">
            <div class="base-info">
                ...
                <div class="job-salary">
                    <span style="color: #C80000;"><i class="fa fa-rmb" style="color: #C80000;"></i>&ensp;<?php echo ($info["salary"]); echo (get_settle_type_unit($info["settle_type"])); ?></span>
                    <span><i class="fa fa-bookmark-o"></i>&ensp;<?php echo ($info["jobname"]); ?></span>
                </div>
                <div class="job-require">
                    <span><i class="fa fa-map-marker"></i>&ensp;<?php echo ($info["work_place"]); ?></span>
                    <span><i class="fa fa-credit-card"></i>&ensp;<?php echo (get_settle_type($info["settle_type"])); ?></span>
                    <span><i class="fa fa-graduation-cap"></i>&ensp;<?php echo (get_academic_career($info["academic_career"])); ?></span>
                </div>
            </div>
            <div class="job-label">
                <span><?php echo ($info["work_day"]); ?></span>
                <span><?php echo ($info["work_time"]); ?></span>
            </div>
