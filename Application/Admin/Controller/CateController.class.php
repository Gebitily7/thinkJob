<?php
// +----------------------------------------------------------------------
// | Gebitily7 [ WE CAN DO IT JUST IT ]
// +----------------------------------------------------------------------
// | Copyright (c) 2016 兼职分类控制器
// +----------------------------------------------------------------------
// | Author: G
// +----------------------------------------------------------------------
...
class CateController extends AdminController {
    ...
    /**
     * 分类管理列表
     * @param  $ismenu 小于等于1-职位分类 1-全职，-1- 兼职，0-前台菜单不调用，大于1-文章分类 2-公告 3-其他公司信息，
     * @author Gebitily7 <zuojiazi@vip.qq.com>
     */
