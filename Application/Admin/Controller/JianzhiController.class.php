 ...
 * @author huajie <banhuajie@163.com>
 */
class JianzhiController extends AdminController {
    ...
    protected function getMenu($ismenu = null){
        ...
        //生成每个分类的url
        foreach ($cate as $key=>&$value){
            $value['url']   =   'Jianzhi/index?cate_id='.$value['id'];
            ...
            if(!empty($value['_child'])){
                ...
                foreach ($value['_child'] as $ka=>&$va){
                    $va['url']      =   'Jianzhi/index?cate_id='.$va['id'];
                    if(!empty($va['_child'])){
                        foreach ($va['_child'] as $k=>&$v){
                            $v['url']   =   'Jianzhi/index?cate_id='.$v['id'];
                            $v['pid']   =   $va['id'];
