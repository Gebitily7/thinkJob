...
class DocumentModel extends Model{
    ...
    protected $_auto = array(
        ...
        array('arr_welfare','getWelfare',self::MODEL_BOTH,'callback'),
    );
    ...
    public function update($data = null){
        ...
        /* 添加或新增扩展内容 */
        $logic = $this->logic($data['model_id']); // 实例化document的子文档
        $logic->checkModelAttr($data['model_id']); // 检测自动完成的字段
        if(!$logic->update($id)){
