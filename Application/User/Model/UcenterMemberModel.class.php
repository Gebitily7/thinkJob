...
class UcenterMemberModel extends Model{
	...
	protected $_validate = array(
		...
		/* 验证公司名称 */
		array('c_name', '2,30', -12, self::EXISTS_VALIDATE,'length'), //长度验证
		array('c_name', 'checkDenyCname', -13, self::EXISTS_VALIDATE, 'callback'), //公司注册回调
		array('c_name', '', -14, self::EXISTS_VALIDATE, 'unique'), // 唯一性
	);
	...
	/**
	 * [checkDenyCname description]
	 * @param  [type] $c_name [description]
	 * @return [type]         [description]
	 */
	protected function checkDenyCname($c_name){
		return true;
	}
	...
	/* 根据id获取用户信息 */
	public function infoDetailc($uid, $field = true, $is_username = false){
		$map = array();
		if($is_username){ //通过用户名获取
			$map['username'] = $uid;
		} else {
	...
	/***/
	public function updateCompanyFields($uid, $data){
